...
__device__ void cornell_box_bvh_scene(Hitable **list, 
                                      Hitable **world, 
                                      curandState *state){
    int i = 0;
    Hitable** objlist = new Hitable*[10];
    ...
    objlist[i++] = new FlipNormals(new RectangleYZ(  0, 555,   0, 555, 555, green));
    objlist[i++] =                (new RectangleYZ(  0, 555,   0, 555,   0,   red));
    objlist[i++] =                (new RectangleXZ(213, 343, 227, 332, 554, light));
    objlist[i++] = new FlipNormals(new RectangleXZ(  0, 555,   0, 555, 555, white));
    objlist[i++] =                (new RectangleXZ(  0, 555,   0, 555,   0, white));
    objlist[i++] = new FlipNormals(new RectangleXY(  0, 555,   0, 555, 555, white));

    objlist[i++] = new Translate(new Rotate(new Box(vec3(0, 0, 0), vec3(165, 165, 165), white), -18), vec3(130, 0,  65));
    objlist[i++] = new Translate(new Rotate(new Box(vec3(0, 0, 0), vec3(165, 330, 165), white),  18), vec3(265, 0, 295));
    
    list[0] = new BVHNode(objlist, i, 0, 1, state);
...
__device__ void boxlist_bvh_scene(Hitable **list, 
                                  Hitable **world, 
                                  curandState *state){
    int nb = 20;
    ...
    list[0] = new BVHNode(boxlist, b, 0, 1, state);
    *world = new HitableList(list, 1);
}
