...
bool RectangleXY::hit(const Ray& r, float t0, float t1, HitRecord& rec) const{
...
bool RectangleXZ::hit(const Ray& r, float t0, float t1, HitRecord& rec) const{
...
bool RectangleYZ::hit(const Ray& r, float t0, float t1, HitRecord& rec) const{
